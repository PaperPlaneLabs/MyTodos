...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_today_task_summary,
            ...
            commands::google_get_events_in_range,
            commands::open_resume_window,
            commands::close_resume_window,
            commands::open_task_timer_finished_window,
            commands::close_task_timer_finished_window,
